      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-bg-secondary/10 backdrop-blur-md border border-border-subtle/50 rounded-lg p-8 mb-8">
            ...
            <p className="text-text-secondary text-center leading-relaxed max-w-3xl mx-auto mb-6">
            ...
            {/* Important Note */}
            <div className="bg-accent-purple/10 border border-accent-purple/30 rounded-lg p-4 max-w-2xl mx-auto">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-text-secondary text-xs leading-relaxed">
                    You need to have at least a free account and one artist profile on{' '}
                    <a 
                      href="https://releaseorganizer.com/" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-accent-purple hover:text-hover-purple underline"
                    >
                      Release Organizer
                    </a>
                    .{' '}
                    <a 
                      href="https://www.youtube.com/@ReleaseOrganizerApp" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-accent-purple hover:text-hover-purple underline"
                    >
